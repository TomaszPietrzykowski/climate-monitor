...
exports.readDailyCO2 = async () => {
  try {
    ...
    logger.log(`Error updating daily co2: ${err}`)
  }
}
...
exports.readAnnualCO2GL = async () => {
  try {
    ...
    logger.log(`Error updating annual co2 gl: ${err}`)
  }
}
exports.readAnnualCO2ML = async () => {
  try {
    ...
    logger.log(`Error updating annual co2 ml: ${err}`)
  }
}
...
exports.readAnnualCO2IncreaseGL = async () => {
  try {
    ...
    logger.log(`Error updating co2 increase gl: ${err}`)
  }
}
exports.readAnnualCO2IncreaseML = async () => {
  try {
    ...
    logger.log(`Error updating annual co2 increase ml: ${err}`)
  }
}
exports.readMonthlyCO2ML = async () => {
  try {
    ...
    logger.log(`Error updating monthly co2 ml: ${err}`)
  }
}
exports.readMonthlyCO2GL = async () => {
  try {
    ...
    logger.log(`Error updating monthly co2 gl: ${err}`)
  }
}
exports.readWeeklyCO2 = async () => {
  try {
    ...
    logger.log(`Error updating weekly co2: ${err}`)
  }
}
